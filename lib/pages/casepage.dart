...
class CasePage extends StatefulWidget{
  ...
  CasePageH createState() => CasePageH(data: 'Test');//, myCPU: myCPU);

}

class CasePageH extends State<CasePage> {
  final String data;
  //CPU myCPU;
  CasePageH({required this.data});
  ...
  Future<List<dynamic>> loadJsonData() async {
    String jsonString = await rootBundle.loadString('assets/case.json');
  ...
  Future<void> _navigateAndSave(BuildContext context, Map<String, dynamic> chosenOne) async{
    final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => CasePageInfo(data: chosenOne)));
    save_Data = "$result";
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  ...
                                  _items[index]['name'] + " " + _items[index]['type']
                                      : searchItem[index]['name']+ " " + searchItem[index]['type'],
...
class CasePageInfo extends StatelessWidget{
  Map<String, dynamic> data;
  CasePageInfo({Key? key, required this.data}) : super(key : key);
...
//"name": "NZXT H510", "rating": 4, "rating_count": 121, "price_usd": 66.98, "type": "ATX Mid Tower", "color": "White", "power_supply": null, "side_panel_window": "Tempered Glass", "external_5.25\"_bays": "0", "internal_3.5\"_bays": "2
              ...
              Text(
                "Side Panel Windows: ${data['side_panel_window']}",
                style: TextStyle(fontSize: CPUInfoTextSize),
              ),
              SizedBox(width: 12, height: 20,),
              ...
              IconButton(
                ...
                color: Colors.green,
                onPressed: (){
                  Navigator.pop(context, data['name'] + " " + data['type']);
                },
              ),
            ],
          ),
