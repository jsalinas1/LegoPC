...
class StoragePage extends StatefulWidget{
  ...
  StoragePageH createState() => StoragePageH(data: 'Test');//, myCPU: myCPU);

}

class StoragePageH extends State<StoragePage> {
  final String data;
  //CPU myCPU;
  StoragePageH({required this.data});
  ...
  Future<List<dynamic>> loadJsonData() async {
    String jsonString = await rootBundle.loadString('assets/internal-hard-drive.json');
  ...
  Future<void> _navigateAndSave(BuildContext context, Map<String, dynamic> chosenOne) async{
    final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => StoragePageInfo(data: chosenOne)));
    save_Data = "$result";
...
class StoragePageInfo extends StatelessWidget{
  Map<String, dynamic> data;
  StoragePageInfo({Key? key, required this.data}) : super(key : key);
